        ...
        const gateMessage = missingRouteBreadthProof
          ...
          : missingContentStructure
            ...
            : missingPremiumMarketingProof
              ? "\n\nAPP_FACTORY_DONE_GATE: Final report blocked. Contractor/local-service marketing site work requires complete autonomous contractor-site proof before claiming completion. Load/follow contractor-site-autonomous-build, run verify_app, and prove `premium_marketing_site_scan` plus full route breadth: home, about, services index, individual service pages, service-areas index, city pages, projects/gallery, reviews, FAQ, contact/quote, privacy, terms, sitemap, and robots. Preserve SPA-safe AppLink/useLocation navigation, a visible Home nav item, LeadOpsVisual, LeadFlowLineSection, LeadLeakAudit, BeforeAfterComparison, StickyAuditRail, dark no-flash base styles, Vercel dist/public static routing, useful city pages, and no glued UI copy. Brochureware plus generic check/build/browser-smoke evidence is not enough."
